...
<div class="cs-stat">
    <div class="cs-stat-card">
        ...
        <div class="val" style="color:#9333ea;"><?php echo e($customers->count()); ?></div>
    </div>
    <div class="cs-stat-card">
        <div class="lbl">With GSTIN</div>
        <div class="val" style="color:#16a34a;"><?php echo e($customers->whereNotNull('gstin')->count()); ?></div>
    </div>
</div>
        ...
        <table class="table table-bordered" id="csTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:11px;max-width:180px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($c->address ?? '—'); ?></td>
                    <td style="text-align:center;white-space:nowrap;">
                        <button onclick="editCustomer(<?php echo e($c->id); ?>)" class="action-btn" style="background:#eef2ff;color:#4338ca;" title="Edit"><i class="ti-pencil"></i></button>
                        <button onclick="deleteCustomer(<?php echo e($c->id); ?>, '<?php echo e(addslashes($c->name)); ?>')" class="action-btn" style="background:#fef2f2;color:#dc2626;margin-left:4px;" title="Delete"><i class="ti-trash"></i></button>
                    </td>
                </tr>
...
<div class="modal fade modal-cs" id="addCustomerModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form method="POST" action="<?php echo e(route('packing-slip.customers.store')); ?>" class="modal-content">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Kovai-Trans\resources\views/PackingSlip/customers.blade.php ENDPATH**/ ?>