...
<div class="ps-hero">
    <div class="row align-items-center">
        <div class="col-md-7" style="position:relative;z-index:1;">
            ...
            <div class="sub"><?php echo e($totalTrips); ?> trips &bull; <?php echo e(number_format($totalQty,0)); ?> Qty &bull; <?php echo e($totalParties); ?> Parties</div>
        </div>
        <div class="col-md-5 text-right mt-2 mt-md-0" style="position:relative;z-index:1;">
            <a href="<?php echo e(route('reports.packing-slip-ledger')); ?>" class="btn btn-sm ps-btn-sm" style="background:rgba(255,255,255,.2);color:#fff;border:1px solid rgba(255,255,255,.3);">
...
<div class="kpi-grid">
    <div class="kpi-card">
        ...
        <div class="kpi-value" style="color:#9333ea;"><?php echo e($totalTrips); ?></div>
    </div>
    <div class="kpi-card">
        <div class="kpi-label">Total Quantity</div>
        <div class="kpi-value" style="color:#16a34a;"><?php echo e(number_format($totalQty,0)); ?></div>
    </div>
    <div class="kpi-card">
        <div class="kpi-label">Parties</div>
        <div class="kpi-value" style="color:#2563eb;"><?php echo e($totalParties); ?></div>
    </div>
    <div class="kpi-card">
        <div class="kpi-label">Vehicles</div>
        <div class="kpi-value" style="color:#d97706;"><?php echo e($totalVehicles); ?></div>
    </div>
    <div class="kpi-card">
        <div class="kpi-label">Invoiced</div>
        <div class="kpi-value" style="color:#16a34a;"><?php echo e($invoiced); ?></div>
    </div>
    <div class="kpi-card">
        <div class="kpi-label">Pending</div>
        <div class="kpi-value" style="color:#dc2626;"><?php echo e($pending); ?></div>
        <div class="kpi-sub"><?php echo e($totalTrips ? round($pending/$totalTrips*100) : 0); ?>% of total</div>
    </div>
</div>
...
<div class="split-row">
    <div class="split-card">
        ...
        <div class="sc-body">
            <?php $maxCnt = $monthly->max('cnt') ?: 1; ?>
            <?php $__empty_1 = true; $__currentLoopData = $monthly; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="month-row">
                <span class="month"><?php echo e(\Carbon\Carbon::parse($m->ym.'-01')->format('M Y')); ?></span>
                <span class="mon-stat">
                    <?php echo e($m->cnt); ?> trips
                    <span class="month-bar"><span class="month-bar-fill" style="width:<?php echo e(round($m->cnt/$maxCnt*100)); ?>%;"></span></span>
                    <span style="font-weight:700;color:#16a34a;margin-left:4px;"><?php echo e(number_format($m->qty,0)); ?></span>
                </span>
            </div>
    ...
    <div class="split-card">
        ...
        <div class="sc-body">
            <?php $maxCnt = $topParties->max('cnt') ?: 1; ?>
            <?php $__empty_1 = true; $__currentLoopData = $topParties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php $p = $partyNames->get($tp->party_id); ?>
            <div class="top-party-item">
                <span class="tp-name"><?php echo e($p ? ($p->company_name ?: $p->name) : '—'); ?></span>
                <span class="tp-stat">
                    <span class="month-bar" style="width:60px;"><span class="month-bar-fill" style="width:<?php echo e(round($tp->cnt/$maxCnt*100)); ?>%;"></span></span>
                    <?php echo e($tp->cnt); ?> trips &bull; <?php echo e(number_format($tp->qty,0)); ?> qty
                </span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <table class="table" id="rctTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:10px;"><?php echo e($t->from_location ?? '—'); ?> → <?php echo e($t->to_location ?? '—'); ?></td>
                    ...
                    <td>
                        <?php if($t->invoice_no): ?>
                        <span class="ps-badge" style="background:#eef2ff;color:#4338ca;"><?php echo e($t->invoice_no); ?></span>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Kovai-Trans\resources\views/PackingSlip/dashboard.blade.php ENDPATH**/ ?>