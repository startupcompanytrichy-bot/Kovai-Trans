...
<div class="alert alert-danger" style="border-radius:10px;font-size:13px;padding:12px 16px;"><?php echo e(session('error')); ?></div>
<?php endif; ?>
...
<div class="cs-card">
    ...
    <div class="cs-table-wrap">
        <table class="table table-bordered" id="qTable">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $qualities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><?php echo e($i+1); ?></td>
                    <td><strong><?php echo e($q->name); ?></strong></td>
                    <td style="text-align:center;white-space:nowrap;">
                        <button onclick="editQuality(<?php echo e($q->id); ?>)" class="action-btn" style="background:#eef2ff;color:#4338ca;" title="Edit"><i class="ti-pencil"></i></button>
                        <button onclick="deleteQuality(<?php echo e($q->id); ?>, '<?php echo e(addslashes($q->name)); ?>')" class="action-btn" style="background:#fef2f2;color:#dc2626;margin-left:4px;" title="Delete"><i class="ti-trash"></i></button>
                    </td>
                </tr>
...
<div class="modal fade modal-cs" id="addQualityModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <form method="POST" action="<?php echo e(route('packing-slip.quality.store')); ?>" class="modal-content">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Kovai-Trans\resources\views/PackingSlip/qualities.blade.php ENDPATH**/ ?>