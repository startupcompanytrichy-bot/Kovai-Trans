                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <div class="par-stat stat-balance">
                            ...
                            <div>
                                ...
                                <div class="sc-value">₹ <?php echo e(number_format($parties->sum('opening_balance') ?? 0, 2)); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="par-stat stat-count">
                            ...
                            <div>
                                ...
                                <div class="sc-value"><?php echo e($parties->count() ?? 0); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="par-table-card">
                    <div class="card-header-custom">
                        ...
                        <span class="badge badge-info" style="font-size:12px; padding:5px 10px; border-radius:20px;">
                            <?php echo e($parties->count()); ?> records
                        </span>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="par-table" id="partiesTable">
                            ...
                            <tbody>
                                ...
                                <tr class="party-row"
                                    data-search="<?php echo e(strtolower($party->name . ' ' . $party->email . ' ' . $party->phone . ' ' . $party->company_name)); ?>">
                                    <td style="color:#b0bac9; font-weight:600; font-size:12px;"><?php echo e($key + 1); ?></td>
                                    <td>
                                        <div class="par-name-cell">
                                            <div class="par-avatar"><?php echo e(mb_substr($party->name, 0, 1)); ?></div>
                                            <div>
                                                <div class="name"><?php echo e($party->name); ?></div>
                                                <?php if($party->company_name): ?>
                                                <div class="company"><i class="ti-briefcase" style="font-size:10px;"></i> <?php echo e($party->company_name); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="party-type-badge"><?php echo e(ucfirst($party->party_type ?? 'Party')); ?></span>
                                    </td>
                                    <td>
                                        <?php if($party->phone): ?>
                                        <span style="font-size:12px; color:#596579;"><i class="ti-mobile" style="color:#b0bac9;"></i> <?php echo e($party->phone); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <?php if($party->email): ?>
                                        <span style="font-size:12px; color:#596579;"><i class="ti-email" style="color:#b0bac9;"></i> <?php echo e($party->email); ?></span>
                                        <?php else: ?>
                                        <span style="color:#d7dce5;">—</span>
                                        <?php endif; ?>
                                    </td>
                                    <td style="text-align:right;">
                                        <span class="balance-cell">₹ <?php echo e(number_format($party->opening_balance ?? 0, 2)); ?></span>
                                    </td>
                                    <td style="text-align:center;">
                                        <div style="display:flex; align-items:center; justify-content:center; gap:5px;">
                                            <button class="btn-action-view" onclick="openPartyPanel('view', <?php echo e($party->id); ?>)" title="View">
                                                <i class="ti-eye"></i>
                                            </button>
                                            <button class="btn-action-edit" onclick="openPartyPanel('edit', <?php echo e($party->id); ?>)" title="Edit">
                                                <i class="ti-pencil"></i>
                                            </button>
                                            <button class="btn-action-del" onclick="deleteParty(<?php echo e($party->id); ?>, '<?php echo e(addslashes($party->name)); ?>')" title="Delete">
                                                <i class="ti-trash"></i>
                                            </button>
                                        </div>
                                        <form id="deleteFormParty<?php echo e($party->id); ?>"
                                            action="<?php echo e(route('parties.destroy', $party->id)); ?>"
...
<div class="par-modal-panel" id="parPanel">
    ...
    <form id="partyForm" method="POST" action="<?php echo e(route('parties.store')); ?>">
        <?php echo csrf_field(); ?>
...
<script>
    ...
    document.getElementById('partyForm').addEventListener('submit', function(e) {
        ...
        if (parMode === 'edit' && parEditId) {
            ...
            url = '<?php echo e(route("parties.store")); ?>';
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Kovai-Trans\resources\views/Parties/Parties.blade.php ENDPATH**/ ?>