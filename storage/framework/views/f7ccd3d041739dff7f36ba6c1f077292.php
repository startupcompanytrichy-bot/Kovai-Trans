...
<div class="ps-hero">
    <div class="row align-items-center">
        <div class="col-md-6">
            ...
            <div class="sub"><?php echo e($slip->bill_no ?? 'No Bill'); ?> &mdash; <?php echo e(optional($slip->slip_date)->format('d/m/Y')); ?></div>
        </div>
        <div class="col-md-6 text-right no-print">
            <a href="<?php echo e(route('packing-slip.index')); ?>" class="btn btn-sm" style="border-radius:8px;background:rgba(255,255,255,.2);color:#fff;border:1px solid rgba(255,255,255,.3);padding:7px 14px;font-weight:600;"><i class="ti-arrow-left mr-1"></i> Back</a>
            <a href="<?php echo e(route('packing-slip.edit', $slip->id)); ?>" class="btn btn-sm" style="border-radius:8px;background:rgba(255,255,255,.2);color:#fff;border:1px solid rgba(255,255,255,.3);padding:7px 14px;font-weight:600;"><i class="ti-pencil mr-1"></i> Edit</a>
...
<div class="ps-card">
    <div class="ps-card-body">
        <div class="row" style="margin-bottom:8px;">
            <div class="col-md-3"><div class="lbl">Bill No</div><div class="val"><?php echo e($slip->bill_no ?? '—'); ?></div></div>
            <div class="col-md-3"><div class="lbl">Lot No</div><div class="val"><?php echo e($slip->lot_no ?? '—'); ?></div></div>
            <div class="col-md-3"><div class="lbl">Date</div><div class="val"><?php echo e(optional($slip->slip_date)->format('d/m/Y')); ?></div></div>
            <div class="col-md-3"><div class="lbl">Customer (TO)</div><div class="val"><?php echo e(optional($slip->customer)->name ?? '—'); ?></div></div>
        </div>
        <div class="row" style="margin-bottom:4px;">
            <div class="col-md-3"><div class="lbl">Quality</div><div class="val"><?php echo e($slip->quality ?? '—'); ?></div></div>
            <div class="col-md-3"><div class="lbl">Invoice</div><div class="val"><?php echo e($slip->invoice_no ?? '—'); ?></div></div>
            <div class="col-md-3"><div class="lbl">Created By</div><div class="val"><?php echo e($slip->created_by ?? '—'); ?></div></div>
...
<div class="summary-row" style="margin-top:16px;">
    <?php $min = $slip->baleItems->min('bale_no'); $max = $slip->baleItems->max('bale_no'); ?>
    <div class="summary-box"><div class="lbl">BALE NO'S</div><div class="val" style="color:#9333ea;"><?php echo e($min && $max ? $min.' - '.$max : '—'); ?></div></div>
    <div class="summary-box"><div class="lbl">NO OF BALE</div><div class="val" style="color:#1a2340;"><?php echo e($slip->no_of_bale ?? 0); ?></div></div>
    <div class="summary-box"><div class="lbl">TOTAL METER</div><div class="val" style="color:#16a34a;"><?php echo e(number_format($slip->total_meter, 2)); ?></div></div>
</div>
...
<div class="bale-grid">
    <?php $groups = $slip->baleItems->groupBy('bale_no'); ?>
    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baleNo => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="bale-section">
        <div class="bale-header">BALE NO : <?php echo e($baleNo); ?></div>
        <table class="bale-table">
            <thead><tr><th style="width:30px;">S.No</th><th>Meter</th><th>Weight</th></tr></thead>
            <tbody>
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="sno-cell"><?php echo e($bi->s_no); ?></td>
                    <td class="num"><?php echo e(number_format($bi->meter, 2)); ?></td>
                    <td class="num"><?php echo e(number_format($bi->weight, 2)); ?></td>
                </tr>
            ...
            <tfoot>
                <tr class="bale-total">
                    ...
                    <td class="tv"><?php echo e(number_format($items->sum('meter'), 2)); ?></td>
                    <td class="tv"><?php echo e(number_format($items->sum('weight'), 2)); ?></td>
                </tr>
            </tfoot>
        </table>
    </div>
...
<div style="background:#f9fafb;border-radius:8px;padding:10px 14px;margin-top:8px;font-size:12px;color:#6b7280;">
    <strong style="color:#374151;">Notes:</strong> <?php echo e($slip->notes); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Kovai-Trans\resources\views/PackingSlip/show.blade.php ENDPATH**/ ?>