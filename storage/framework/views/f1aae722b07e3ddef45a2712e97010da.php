...
<nav class="navbar header-navbar pcoded-header">
    ...
    ">
        ...
        ">
                ...
                <?php $dbranchId = \App\Models\Setting::getValue('default_branch'); $dbranch = $dbranchId ? \App\Models\Branch::find($dbranchId) : null; ?>
                <?php if($dbranch): ?>
                <li class="fy-li">
                    <div style="display:flex;align-items:center;gap:10px;padding:6px 12px;border-radius:30px;background:#fff;border:1px solid #e5e7eb;box-shadow:0 2px 6px rgba(0,0,0,0.06);cursor:default;">
                        ...
                        <div style="line-height:1.1;">
                            ...
                            <div style="font-size:13px;font-weight:700;color:#111827;"><?php echo e($dbranch->branch_name); ?></div>
                        </div>
                    </div>
                </li>
                <?php endif; ?>
