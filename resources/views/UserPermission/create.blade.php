...
<style>
    ...
    .btn-up-secondary:hover {
        background: #cbd5e1;
        color: #1e293b;
    }

    /* ── Select2 outside container match page style ── */
    .up-body .select2-container--default .select2-selection--single {
        min-height: 38px !important;
        height: 38px !important;
        border: 1.5px solid #e2e8f0 !important;
        border-radius: 8px !important;
    ...
    .up-body .select2-container--default .select2-selection--single .select2-selection__rendered {
        font-size: 12px !important;
    ...
    .up-body .select2-container--default .select2-selection--single .select2-selection__placeholder {
        color: #94a3b8 !important;
        font-size: 12px !important;
    }

    .up-body .select2-container--default.select2-container--focus .select2-selection--single,
    .up-body .select2-container--default.select2-container--open .select2-selection--single {
        border-color: #7c3aed !important;
        box-shadow: 0 0 0 3px rgba(124, 58, 237, .15) !important;
    }

    .up-body .select2-container--default .select2-selection--single .select2-selection__arrow {
        right: 6px !important;
    }

    .up-body .select2-container--default .select2-selection--single .select2-selection__arrow b {
        border-width: 4px 4px 0 4px !important;
    }

    .up-body .select2-container--default.select2-container--open .select2-selection--single .select2-selection__arrow b {
        border-width: 0 4px 4px 4px !important;
    }

    .up-body .select2-container--default .select2-selection--multiple {
        min-height: 38px !important;
    ...
    .up-body .select2-container--default.select2-container--focus .select2-selection--multiple,
    .up-body .select2-container--default.select2-container--open .select2-selection--multiple {
        border-color: #7c3aed !important;
        box-shadow: 0 0 0 3px rgba(124, 58, 237, .15) !important;
    }

    .up-body .select2-container--default .select2-selection--multiple .select2-selection__choice {
    ...
    .up-body .select2-container--default .select2-selection--multiple .select2-selection__choice__remove {
    ...
    .up-body .select2-container--default .select2-selection--multiple .select2-selection__choice__remove:hover {
        background: rgba(239, 68, 68, .1) !important;
        color: #dc2626 !important;
    }

    .up-body .select2-container--default .select2-selection--multiple .select2-selection__placeholder {
        color: #94a3b8 !important;
        font-size: 12px !important;
    }

    .up-body .select2-container--default .select2-selection--multiple .select2-search__field {
        font-size: 12px !important;
        height: 22px !important;
        color: #1e293b !important;
    }

    .up-body .select2-dropdown {
        border-radius: 8px !important;
        border-color: #e2e8f0 !important;
        box-shadow: 0 4px 16px rgba(0, 0, 0, .1) !important;
    }

    .up-body .select2-results__option {
        font-size: 12px !important;
        padding: 7px 12px !important;
    }

    .up-body .select2-results__option[aria-selected="true"] {
        background: #eef2ff !important;
        color: #4f46e5 !important;
    }

    .up-body .select2-container--default .select2-results__option--highlighted[aria-selected] {
                ...
                <div class="up-header">
                    <div class="row align-items-center">
                        <div class="col-md-8" style="position:relative;z-index:1;">
                            <h4><i class="ti-plus mr-2"></i>Create New User</h4>
                            <div class="sub">Add a new user to the system.</div>
                        </div>
                    </div>
                </div>
