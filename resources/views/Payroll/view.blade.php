    ...
    <div class="pf-card">
        ...
        <div class="pf-card-body" style="padding:0;">
            <table class="table mb-0" style="font-size:13px;">
                ...
                <tbody>
                    <tr>
                        <td style="color:#38a169;padding:10px 14px;">Basic Salary</td>
                        <td style="text-align:right;padding:10px 14px;font-weight:700;">₹ {{ number_format($payroll->basic_salary,2) }}</td>
                        <td style="color:#e53e3e;padding:10px 14px;">PF</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->pf,2) }}</td>
                    </tr>
                    <tr>
                        <td style="color:#38a169;padding:10px 14px;">HRA</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->hra,2) }}</td>
                        <td style="color:#e53e3e;padding:10px 14px;">ESI</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->esi,2) }}</td>
                    </tr>
                    <tr>
                        <td style="color:#38a169;padding:10px 14px;">DA</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->da,2) }}</td>
                        <td style="color:#e53e3e;padding:10px 14px;">TDS</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->tds,2) }}</td>
                    </tr>
                    <tr>
                        <td style="color:#38a169;padding:10px 14px;">Other Allowance</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->other_allowance,2) }}</td>
                        <td style="color:#e53e3e;padding:10px 14px;">Advance Recovery</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->advance_deduction,2) }}</td>
                    </tr>
                    <tr>
                        <td style="color:#38a169;padding:10px 14px;">Bonus</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->bonus,2) }}</td>
                        <td style="color:#e53e3e;padding:10px 14px;">Other Deduction</td>
                        <td style="text-align:right;padding:10px 14px;">₹ {{ number_format($payroll->other_deduction,2) }}</td>
                    </tr>
                    <tr style="background:#f4f6fb;font-weight:800;font-size:14px;">
                        <td style="color:#38a169;padding:10px 14px;">Total Earnings</td>
                        <td style="text-align:right;padding:10px 14px;color:#38a169;">₹ {{ number_format($payroll->gross_salary,2) }}</td>
                        <td style="color:#e53e3e;padding:10px 14px;">Total Deductions</td>
                        <td style="text-align:right;padding:10px 14px;color:#e53e3e;">₹ {{ number_format($payroll->total_deductions,2) }}</td>
                    </tr>
                </tbody>
            </table>
            <div class="net-box">
