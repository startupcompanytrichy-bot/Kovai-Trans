                    ...
                    <div class="d-flex align-items-start justify-content-between flex-wrap" style="gap:12px;">
                        ...
                        <div style="position:relative;z-index:1;">
                            <a href="{{ route('vehicle') }}"
                               onclick="event.preventDefault(); window.softNav('{{ route('vehicle') }}');"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <select name="owner_type" class="form-control select2-edit">
                                            ...
                                            <option value="Rental" {{ old('owner_type', $vehicle->owner_type) == 'Rental' ? 'selected' : '' }}>Rental</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <select name="supplier_id" class="form-control select2-edit">
                                            ...
                                            <option value="{{ $s->id }}" {{ old('supplier_id', $vehicle->supplier_id) == $s->id ? 'selected' : '' }}>{{ $s->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <select name="vehicle_type" class="form-control select2-edit" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-veh">
                                        ...
                                        <input type="text" name="vehicle_name" class="form-control"
                                               ...
                                               placeholder="e.g. Ashok Leyland 2518" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-veh">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <input type="text" name="engine_number" class="form-control"
                                               value="{{ old('engine_number', $vehicle->engine_number) }}" placeholder="Engine Number" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <input type="text" name="chassis_number" class="form-control"
                                               value="{{ old('chassis_number', $vehicle->chassis_number) }}" placeholder="Chassis Number" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <input type="text" name="rc_number" class="form-control"
                                               value="{{ old('rc_number', $vehicle->rc_number) }}" placeholder="RC Number" maxlength="50">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <select name="permit_type" class="form-control select2-edit" required>
                                            ...
                                            <option value="{{ $val }}" {{ old('permit_type', $vehicle->permit_type) == $val ? 'selected' : '' }}>{{ $lbl }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group-veh">
                                        ...
                                        <input type="text" name="permit_number" class="form-control"
                                               value="{{ old('permit_number', $vehicle->permit_number) }}" placeholder="Permit Number" maxlength="50">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $('#editForm').on('submit', function (e) {
        ...
        .then(function (r) {
            if (r.ok) {
                ...
                btn.disabled = false;
                btn.innerHTML = '<i class="ti-save mr-1"></i> Update Vehicle';
                return;
            }
            btn.disabled = false;
            btn.innerHTML = '<i class="ti-save mr-1"></i> Update Vehicle';
            r.json().then(function (data) {
                ...
                html += '</ul></div>';
                var errEl = document.getElementById('vehFormErrors');
                if (!errEl) {
                    errEl = document.createElement('div');
                    errEl.id = 'vehFormErrors';
        ...
        .catch(function () {
            ...
            errEl.innerHTML = '<div class="alert alert-danger">Network error. Please try again.</div>';
        });
    });
