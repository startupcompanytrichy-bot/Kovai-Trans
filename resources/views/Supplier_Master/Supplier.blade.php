...
<style>
    ...
    .sup-stat.stat-total .sc-icon {
        background: #eef2ff;
        color: #667eea;
    }

    .sup-stat.stat-active {
        border-left-color: #38a169;
    }

    .sup-stat.stat-active .sc-icon {
        background: #f0fff4;
        color: #38a169;
    }
    ...
    .sup-table-card .card-header-custom h5 {
        margin: 0;
        font-size: 15px;
        font-weight: 700;
        color: #1a2340;
    ...
    .sup-table-card .card-header-custom .sub {
        font-size: 12px;
        color: #8a94a6;
        margin-top: 2px;
    }
    ...
    .sup-panel-header .panel-close:hover {
        background: #e53e3e;
    }
...
<script>
    ...
    function supShowErrors(xhr) {
        ...
        document.getElementById('supErrorContainer').scrollIntoView({
            behavior: 'smooth',
            block: 'start'
        });
    }
