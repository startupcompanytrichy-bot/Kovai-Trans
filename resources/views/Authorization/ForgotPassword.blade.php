    ...
    <div class="wrapper">
        ...
        <div class="right">
            <div class="login-box">
                ...
                <div class="subtitle">Enter your email to receive an OTP</div>
                ...
                <form method="POST" action="{{ route('password.send-otp') }}">
                    ...
                    <div class="input">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Registered Email Address" value="{{ old('email') }}" required autofocus>
                    </div>
                    @error('email')
